...
-- User table with columns in snake_case format
CREATE TABLE User (
...
CREATE TABLE Professor (
                           ...
                           average_grade TINYINT COMMENT 'Average grade given by the professor 1-5',
...
CREATE TABLE Course (
                        ...
                        professor_id INT NOT NULL COMMENT 'Foreign key referencing Professor table',
                        credits TINYINT COMMENT 'Number of credits 1-10',

                        difficulty TINYINT COMMENT 'Difficulty level of the course, 1=简单, 2=中等, 3=困难',
                        homework_amount TINYINT COMMENT 'Amount of homework, 1=很少, 2=中等, 3=超多',
                        grading_fairness TINYINT COMMENT 'Fairness or leniency of grading, 1=超坏, 2=一般, 3=超好',
                        learning_gain TINYINT COMMENT 'Overall learning gain or experience, 1=很少, 2=一般, 3=很多',

                        average_score TINYINT COMMENT 'Average score of the course 1-5',
